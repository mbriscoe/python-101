...
while len(deck_of_cards) > 1:
    ...
    if player1_card[0] > player2_card[0]:
        # display cards
        print(
            f"{Fore.GREEN}Player 1 card: {p1_card_name} of {player1_card[1]}")
    ...
    # if player 2 wins
        ...
        print(
            f"{Fore.GREEN}Player 2 card: {p2_card_name} of {player2_card[1]}")
        print(Style.RESET_ALL)
...
if input("would you like to see the player's packs (y/n)?").upper() == "Y":
